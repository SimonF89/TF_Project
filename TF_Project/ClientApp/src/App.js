...
var htmleditor_1 = require("./components/widgets/htmleditor");
require("./custom.css");
exports.default = (function () { return (React.createElement(Layout_1.default, null,
    ...
    React.createElement(react_router_1.Route, { path: '/hello-test', component: Hello_1.default }),
    React.createElement(react_router_1.Route, { path: '/html-editor', component: htmleditor_1.default }))); });
